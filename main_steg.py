...
def main():
    parser = argparse.ArgumentParser(description='CS-7389 Project: Steganography Tool', epilog="Example commands:\n"
                                            "  Hide: python main_steg.py hide host.png secret.txt mypublickey.pem output.png\n"
                                            "  Extract: python main_steg.py extract carrier.png myprivatekey.pem [extracted.txt]",
                                     formatter_class=argparse.RawDescriptionHelpFormatter)
    subparsers = parser.add_subparsers(dest='command')

    # Subparser for hiding a file
    hide_parser = subparsers.add_parser('hide', help='Hide a file inside an image', epilog="Example: python main_steg.py hide host.png secret.txt mypublickey.pem output.png", formatter_class=argparse.RawDescriptionHelpFormatter)
    ...
    extract_parser = subparsers.add_parser('extract', help='Extract a file from an image', epilog="Example: python main_steg.py extract carrier.png  myprivatekey.pem [extracted.txt]",
                                           formatter_class=argparse.RawDescriptionHelpFormatter)
